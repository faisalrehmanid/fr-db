...
/**
 * This class implements \FR\Db\ExpressionInterface specifically for Oracle
 */
class Expression extends ExpressionAbstract
{
    ...
    public function setDate($value = '')
    {
        ...
        return new SQLFragment(" TO_DATE($key, '" . $sql_format . "') ", array($key => $value));
    }
    ...
    public function setUuid($value)
    {
        ...
        $key = $this->generateUniqueKey($value);
        return new SQLFragment(" LOWER($key) ", array($key => $value));
    }
}
